...
export default {
  ...
  setup() {
    ...
    function createColumn() {
      ...
      this.$nextTick(() =>
        document.querySelector(".column:last-of-type .title-column").focus()
      );
    }
...
<template>
  <div class="board flex gap-3 overflow-auto">
    <draggable
      :group="{ name: 'columns' }"
      handle=".drag-handle"
      animation="300"
    ...
    >
      <transition-group class="flex gap-4 items-start">
        <div
          ...
          :key="column.id"
          class="column relative bg-gray-200 p-5 rounded min-w-[250px]"
        >
          ...
          <div class="">
            <draggable
              ...
              class="container-tasks border-t-2"
            ...
            >
              <transition-group
                class=""
                :class="{
                  'block min-h-[1px] duration-500': column.tasks.length == 0,
                }"
              >
                <BoardTask
                  :task="task"
